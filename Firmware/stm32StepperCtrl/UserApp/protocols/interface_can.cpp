...
extern Motor motor;
extern MasterSyncer masterSyncer;
...
void OnCanCmd(uint8_t _cmd, uint8_t* _data, uint32_t _len)
{
    ...
    switch (_cmd)
    {
        ...
        case 0x05:  // Set Position SetPoint. Tapezoidal scheduling?
...
//            CAN_Send(&txHeader, _data);
        ...
        case 0x25: // Set master-sync interval
        {
            masterSyncer.setInterval(*(uint32_t*) (RxData));
        }
            break;
